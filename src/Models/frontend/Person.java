...
//    }
    ...
    public Models.backend.Person initPersonBackend(){

        Models.backend.Person person1 = new Models.backend.Person(this.getID(), this.firstName, this.lastName, this.type.toString());
        return person1;
    }
}
