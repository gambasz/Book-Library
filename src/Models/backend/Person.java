...
public class Person {
    ...
    private ArrayList<Models.frontend.Resource> initResourceListGUI(ArrayList<Resource> tempList){
        ArrayList<Models.frontend.Resource> returnedList = new ArrayList<Models.frontend.Resource>();
    ...
    public Models.frontend.Person initPersonGUI(){
        ...
        Models.frontend.Person p = new Models.frontend.Person(this.last_name,this.first_name,this.id, enumTmp.toString());
