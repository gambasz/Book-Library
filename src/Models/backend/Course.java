...
public class Course {
    ...
    public Models.frontend.Course initCourseGUI(){
    ...
    public Models.frontend.Course initCourseGUIBasic(){
        Models.frontend.Course tmp = new Models.frontend.Course(this.id,this.title,this.department,this.description);
        tmp.setCommonID(this.commonID);
        return tmp;
    }

    public Models.frontend.Course initCourseGUI(int year, String semester){
        ArrayList <Models.frontend.Resource> tmpResource = new ArrayList<Models.frontend.Resource>();
