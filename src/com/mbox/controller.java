...
//        retrunedList.add("1. What do you third? \n 2. testing button\n");
        retrunedList.add("1. Current year & semester of all classes in the table \n" +
        ...
        retrunedList.add("1. Press this button to open detailed course view \n" +
        ...
        retrunedList.add("1. Press this button to open detailed professor view \n" +
                ...
                "5. Press Fill to fulfill the text fields in the main view");
        retrunedList.add("1. Press Edit button to open detailed resources view \n" +
        ...
        retrunedList.add("1. Press Publisher button in the publisher fields to open detailed publisher view \n" +
        ...
        retrunedList.add("After adding/changing all the information in the left column" +
                "\n" +
